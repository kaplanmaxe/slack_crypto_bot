...
_Bittrex2.default.getMarketData().then(function (res) {
  ...
  return Promise.all([_Slack2.default.sendMessage(_env.altcoinSlackChannel, _Slack2.default.formAltcoinMessage(res.slice(5, 10), 'Worst')), _Slack2.default.sendMessage(_env.altcoinSlackChannel, _Slack2.default.formAltcoinMessage(res.slice(0, 5), 'Best'))]);
}).then(function () {
  db.close();
  process.exit();
});